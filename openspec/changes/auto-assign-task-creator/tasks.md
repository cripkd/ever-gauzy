...
- [x] 1.1 Add a Playwright spec under `apps/poc-e2e/tests/` that logs in as
...
- [x] 1.2 In the same spec, add a case where the Employee creates a new
...
- [x] 2.1 In `packages/core/src/lib/tasks/commands/handlers/task-create.handler.ts`,
