...
- [ ] 1.1 Write `apps/poc-e2e/tests/task-assignment.spec.ts`: log in as an
...
- [ ] 2.1 Add `data-testid` attributes to
...
- [ ] 2.2 Fix task creation so the creating Employee ends up in the task's
